...
COOKIES_FILE = os.getenv("COOKIES_FILE", "cookies.txt")  # مسیر فایل کوکی (اختیاری، برای اینستاگرام)
...
def format_selection_map():
    return {
        "high": "bestvideo[height<=1080]+bestaudio/best[height<=1080]/bestvideo+bestaudio/best",
        "medium": "bestvideo[height<=480]+bestaudio/best[height<=480]/bestvideo+bestaudio/best",
        "low": "bestvideo[height<=240]+bestaudio/best[height<=240]/bestvideo+bestaudio/best",
